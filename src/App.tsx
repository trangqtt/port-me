export default function App() {
  return (
    <main className="flex min-h-dvh flex-col items-start justify-center gap-12 px-10 py-20 md:px-20">
      ...
      <h1 className="font-display text-[clamp(3rem,10vw,9rem)] font-bold leading-[0.95] tracking-[-0.04em] text-balance">
        Building{" "}
      ...
      <div className="grid w-full max-w-5xl grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <section>
          ...
          <p className="mt-3 font-display text-3xl font-thin">UltraLight 100</p>
        ...
        <section>
          ...
          <p className="font-accent text-3xl font-normal">
            Regular 400 <span className="italic text-primary/60">Italic</span>
          </p>
          <p className="font-accent text-3xl font-medium">
            Medium 500 <span className="italic text-primary/60">Italic</span>
          </p>
