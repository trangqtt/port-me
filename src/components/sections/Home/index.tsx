...
export function Home() {
  ...
  return (
    <section
      ...
      className="relative w-full overflow-hidden bg-primary px-5 pt-25 pb-20 sm:px-8 lg:px-[4.48vw] lg:pt-0 lg:pb-0"
    >
      <div className="relative z-10 flex flex-col gap-17 lg:block lg:aspect-1920/1080 lg:w-full min-h-screen">
        <div className="flex flex-col gap-4 lg:contents">
          ...
          <p className="max-w-75 font-accent text-sm uppercase leading-[1.2] text-primary/70 lg:absolute lg:left-[4.01%] lg:top-[30.83%] lg:w-[15.57%] lg:max-w-none lg:text-base">
        ...
        <div
          aria-hidden="true"
          className="items-end gap-2 font-accent text-base uppercase text-primary/70 absolute left-0 right-0 bottom-0"
        >
          <div className="flex justify-between font-accent text-sm uppercase leading-[1.2] text-primary/70 lg:text-base">
            ...
            <span className="hidden lg:flex"> @2026</span>
            <span className="hidden lg:flex"> Scroll more [→]</span>
          </div>
          <p
            aria-hidden="true"
